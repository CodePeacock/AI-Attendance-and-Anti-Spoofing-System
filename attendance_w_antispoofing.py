...
from tkinter.ttk import Combobox, Progressbar, Scrollbar, Treeview
    ...
    if username_var.get() == "" or password_var.get() == "":
        ...
        try:
            conn = pymysql.connect(
                host="localhost", user="root", password="", database="recognition"
            )
            curr = conn.cursor()
            curr.execute(
            ...
            if row is None:
                ...
                def manage_employee():
                    try:
                        ...
                        bg_photo = PhotoImage(
                            file="Photos/background3.png", master=first
                        )
                        ...
                        def add_employee():
                            ...
                            if (
                                ...
                                messagebox.showerror(
                                    "Error", "All fields are Required", parent=first
                                )
                            else:
                                if re.search("[a-zA-Z]+", fname_var.get()):
                                        ...
                                        if re.search("^[9]\d{9}$", contact_var.get()):
                                            ...
                                            if re.search(regex, address_var.get()):
                                                ...
                                                if not os.path.exists(input_directory):
                                                    ...
                                                    cur1 = conn.cursor()
                                                    cur1.execute(
                                                        "insert into attendance(department,fname,gender,contact_no,email_address,date_of_join) VALUES (%s,%s,%s,%s,%s,%s)",
                                                        (
                                                            post_var.get(),
                                                            fname_var.get(),
                                                            gender_var.get(),
                                    ...
                                    messagebox.showerror(
                                        "Error",
                                        "Full Name must be String Character",
                                        parent=first,
                                    )
                                            ...
                                            if re.search(regex, address_var.get()):
                                                ...
                                                if id in staff_ids:
                                                    ...
                                                    if q is True:
                                                        ...
                                                        cv2.destroyAllWindows()
                                                        cur.execute(
                                                            "update attendance set department = %s, fname = %s, gender = %s, contact_no = %s, email_address = %s where eid = %s",
                                                            (
                                                                post_var.get(),
                                                                fname_var.get(),
                                                                gender_var.get(),
                                                    ...
                                                    ques = messagebox.askyesno(
                                                        "Notification",
                                                        "Photo samples for this staff didnot exist in local directory. Please delete the entry from the database",
                                                        parent=attendance,
                                                    )
                                                    if ques is True:
                                                        delete()
                            ...
                            if (
                                ...
                                try:
                                    ...
                                    if not os.path.exists(staff_input):
                                        cur.execute(
                                            "delete from attendance where eid = %s",
                                            eid_var.get(),
                                        )
                                    else:
                                        cur.execute(
                        ...
                        def search_data():
                            ...
                            if len(data) != 0:
                                ...
                                messagebox.showinfo(
                                    "Sorry", "No Data Found", parent=first
                                )
                            conn.close()
                        ...
                        E1 = Entry(
                            ...
                            state="disabled",
                            width=20,
                            textvariable=eid_var,
                            font=("italic", 13, "bold"),
                        ).place(x=180, y=100)
                        post = Label(
                            f2, text="Post", bg="gray", font=("italic", 13, "bold")
                        ).place(x=35, y=150)
                        E2 = Entry(
                            f2,
                            width=20,
                        ...
                        name = Label(
                            f2, text="Full Name", bg="gray", font=("italic", 13, "bold")
                        ).place(x=35, y=200)
                        E3 = Entry(
                            f2,
                            width=20,
                        ...
                        gender = Label(
                            f2, text="Gender", bg="gray", font=("italic", 12, "bold")
                        ).place(x=35, y=250)
                        E7 = Combobox(
                            f2,
                        ...
                        c1 = Combobox(
                            first,
                            textvariable=search_from,
                            values=["eid", "fname", "post"],
                            state="readonly",
                            width="25",
                        ).place(x=580, y=109)
                        E7 = Entry(
                            first,
                            textvariable=search_result,
                            width="25",
                        ...
                        print(e)
                        messagebox.showerror(
                            "Error", "Close all the windows and restart your program"
                        )
                ...
                def train():
                    try:
                        ...
                        second.iconbitmap(
                            "Photos/Hopstarter-Soft-Scraps-User-Group.ico"
                        )
                        ...
                        def progress():
                            ...
                            try:
                                training_obj = Training(
                                    embedding_path="models/embeddings.pickle"
                                )
                                [
                                    label,
                                    labels,
                                    Embeddings,
                                    ids,
                                ] = training_obj.load_embeddings_and_labels()
                                recognizer = training_obj.create_svm_model(
                                ...
                                messagebox.showerror(
                                    "Error",
                                    "Pickle file for embeddings is missing. {} not found.First Extract Embeddings and then try again".format(
                                        str(e).split(":")[-1]
                                    ),
                                )
                        ...
                        progress_bar = Progressbar(
                            second, orient=HORIZONTAL, length=500, mode="determinate"
                        )
                ...
                def face_recognize():
                    embeddings_model_file = os.path.join(
                        root_dir, "models/embeddings.pickle"
                    )
                    recognizer_model_file = os.path.join(
                        root_dir, "models/recognizer.pickle"
                    )
                    predictions = []
                    liveness_predictor = []
                    if os.path.exists(embeddings_model_file and recognizer_model_file):
                        ...
                        recognizer = pickle.loads(
                            open("models/recognizer.pickle", "rb").read()
                        )
                        ...
                        if final_label == "real":
                            ...
                            cur1 = conn.cursor()
                            cur1.execute(
                                "select name,date from report where name = %s and date = %s",
                                (final_name, date),
                            )
                            data = cur1.fetchall()
                            if len(data) != 0:
                                messagebox.showwarning(
                                    "Warning",
                                    "Sorry {}.Your attendance has already been recorded".format(
                                        final_name
                                    ),
                                )
                            else:
                                if (
                                    int(time_hour) >= start_hour
                                    and int(time_hour) <= end_hour
                                ):
                                    cur2 = conn.cursor()
                                    cur2.execute(
                                        "insert into report(id,name,date,time,status) VALUES (%s,%s,%s,%s,%s)",
                                        (final_id, final_name, date, time, status),
                                    )

                                    conn.commit()
                                    messagebox.showinfo(
                                        "Success",
                                        "Hello {}.Your attendance has been recorded successfully".format(
                                            final_name
                                        ),
                                    )
                        else:
                        ...
                        messagebox.showerror(
                            "Error",
                            "Model file not found. Embeddings.pickle file and Recognizer.pickle file must exist within models directory.",
                        )
                ...
                def change():
                    ...
                    admin_logo = Label(
                        account_frame, image=logo_icon, bg="white"
                    ).place(y=70, relwidth=1)
                    ...
                    user_entry = Entry(
                        account_frame,
                        font=("times new roman", 14, "bold"),
                        textvariable=newuser_var,
                    ).place(x=210, y=275)
                    newpass_logo = Label(account_frame, image=pass_icon).place(
                        x=7, y=325
                    )
                    newpass_label = Label(
                        account_frame,
                    ...
                    def user_change():
                        if (
                            ...
                            messagebox.showerror(
                                "Error", " All fields are Required", parent=account
                            )
                        else:
                            conn = pymysql.connect(
                                host="localhost",
                            ...
                            if row is None:
                                messagebox.showerror(
                                    "Error", "Invalid Old Password", parent=account
                                )
                            else:
                                cur.execute(
                                    "update login set password = %s , username = %s",
                ...
                def report():
                    ...
                    def delete_data():
                        ...
                        messagebox.showinfo(
                            "Success", " Data Deleted Successfully", parent=report
                        )
                        conn.close()
                    ...
                    table_frame = Frame(
                        text_fill, borderwidth="3", relief=GROOVE, bg="white"
                    )
                    table_frame.place(x=10, y=55, height=560, width=1325)
                    scroll_x = Scrollbar(table_frame, orient=HORIZONTAL)
                    scroll_y = Scrollbar(table_frame, orient=VERTICAL)
                    report_table = Treeview(
                        table_frame,
                ...
                def photo_samples():
                    global my_image
                    attendance.photo_paths = filedialog.askopenfilename(
                        initialdir="./dataset",
                        title="Select Photo",
                ...
                def face_embedding():
                    ...
                    embed_title = Label(
                        fe,
                        text="Extract And Save Embeddings",
                        font=("times new roman", 30, "bold"),
                        bg="brown",
                    )
                    ...
                    if not os.path.exists(embeddings_model_file):
                        ...
                        face_pixels = embedding_obj.normalize_pixels(
                            imagearrays=image_arrays
                        )
                        ...
                        textlabel = Label(
                            fe, textvariable=text, font=("Times new roman", 16, "bold")
                        )
                        textlabel.place(x=475, y=500)
                        btn = Button(
                            fe,
                            text="Start Extracting Embeddings",
                            fg="white",
                            font=("Times new roman", 20, "bold"),
                            command=lambda: start_extracting_embedding(
                                pixels=face_pixels
                            ),
                            bg="green",
                        )
                        ...
                        [old_data, unique_names] = embedding_obj.check_pretrained_file(
                            embeddings_model_file
                        )
                        remaining_names = embedding_obj.get_remaining_names(
                            staff_details, unique_names
                        )
                        data = embedding_obj.get_remaining_face_pixels(
                            staff_details, remaining_names
                        )
                        if data is not None:
                            [
                                image_ids,
                            ...
                            def start_extracting_embedding(pixels):
                                ...
                                combined_data["paths"] = (
                                    old_data["paths"] + new_data["paths"]
                                )
                                combined_data["names"] = (
                                    old_data["names"] + new_data["names"]
                                )
                                combined_data["face_ids"] = (
                                    old_data["face_ids"] + new_data["face_ids"]
                                )
                                combined_data["imageIDs"] = (
                                    old_data["imageIDs"] + new_data["imageIDs"]
                                )
                                combined_data["embeddings"] = (
                                    old_data["embeddings"] + new_data["embeddings"]
                                )
                            ...
                            messagebox.showinfo(
                                "Warning",
                                "No new staffs found. Embeddings already existed for these staffs",
                            )
                            fe.after(1000, fe.destroy)
                ...
                B1 = Button(
                    ...
                    height=230,
                    width=265,
                    command=manage_employee,
                    compound=BOTTOM,
                )
                B1.place(x=20, y=100)

                photo2 = PhotoImage(
                    file="Photos/face_recognizer.png", master=attendance
                )
                B2 = Button(
                    attendance,
                    image=photo2,
...
logo_image = Label(login_frame, image=logo_icon, bd=0).grid(
    row=0, columnspan=3, pady=40, padx=40
)
...
user_label = Label(
    ...
    compound=LEFT,
    font=("times new roman", 15, "bold"),
).grid(row=1, column=0, padx=30, pady=5)
user_entry = Entry(
    login_frame,
    font=("times new roman", 15, "bold"),
    relief=GROOVE,
...
submit_btn = Button(
    ...
    relief=GROOVE,
    bg="green",
).grid(row=3, column=1, pady=25, padx=25)
face.mainloop()
